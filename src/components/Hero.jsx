  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32  relative inline-flex flex-col  w-full justify-center
     ...
     <div className='text-center mb-6'>
      ...
      <p className='mt-4 max-w-xs m-auto max-sm:text-xs text-grey-600'>Transform your content creation with our suit  of premium AI tools.
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        active:scale-95 transition cureser-pointer'>Start creating now</button>
        <button className='bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-102
        active:scale-95 transition curser-pointer'>Watch demo</button>
      </div>
      <div className='flex item-center gap-4 mt-8 mx-auto text-grey-600'>
